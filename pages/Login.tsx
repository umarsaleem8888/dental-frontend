    ...
    <>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        <div className="w-full max-w-[380px] relative z-10 animate-in fade-in zoom-in-95 duration-500">
          <div className="  dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden p-6 space-y-2">
            <div className="text-center space-y-0">
              ...
              <h1 className="text-[20px] font-black tracking-tight">DentalExpert Login</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-2">
              <div className="space-y-2">
                ...
                <div className="z-[-10] space-y-3">
                  ...
                  <div className="  relative flex bg-slate-100 dark:bg-slate-800 rounded-xl p-1">
                    ...
                    <button
                      ...
                      className={`relative z-10 flex-1 py-2.5 text-xs font-bold rounded-lg transition-colors ${isAdmin ? "text-white" : "text-slate-500"
                        }`}
                    >
                      Admin
                    </button>
              ...
              <div className='flex gap-1 ' >
                <button
                  type="submit"
                  disabled={loading}
                  className="w-[100%] bg-blue-500 hover:bg-blue-600  text-white font-black py-3.5 rounded-xl shadow-lg shadow-primary-500/10 flex items-center justify-center gap-2 transition-all active:scale-[0.97] group text-sm uppercase tracking-widest disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    "Loading ..."
                  ) : (
