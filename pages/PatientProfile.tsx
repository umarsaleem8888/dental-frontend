    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4">
          ...
          {/* Detailed Info Card */}
          <div className="mt-[20px] bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm space-y-8">
            <div className="flex items-center justify-between">
              <h4 className="font-black text-xs tracking-widest text-slate-400 uppercase">Patient Profile</h4>
              <button onClick={() => navigate(`/patients/edit/${id}`)} className="text-primary-500 font-bold text-xs hover:underline">Edit Info</button>
            </div>
        ...
        <div className="lg:col-span-8">
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden h-[481px] flex flex-col">
            {/* Tab Navigation */}
          ...
          {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-[20px] ">
