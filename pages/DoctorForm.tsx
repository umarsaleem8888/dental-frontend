...
const DoctorEdit: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const d = await apiPost(`/doctors/`, payload);
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Add Practitioner</h2>
          <p className="text-slate-500">Add specialist details and availability.</p>
        </div>
      </div>
